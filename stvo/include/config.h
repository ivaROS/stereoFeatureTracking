...
public:
    ...
    static bool&    useOrbslam2Extractor()  { return getInstance().use_orbslam2_extractor; }
    static int&     iniThFAST()         { return getInstance().ini_th_fast; }
    static int&     minThFAST()         { return getInstance().min_th_fast; }
    ...
    static double&  maxDisp()           { return getInstance().max_disp; }
