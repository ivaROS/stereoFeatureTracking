...
public:
    ...
    inline void loadCam( PinholeStereoCamera* cam_) { cam = cam_; }
    ...
    void plotLeftPair();
    void plotLeftPair(Mat& tracked_img);
    ...
    vector< PointFeature* > matched_pt;
    vector< LineFeature*  > matched_ls;
    
    int num_tracked_pt = -1;
